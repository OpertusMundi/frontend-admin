...
interface ConsumerFiltersProps extends WithStyles<typeof styles> {
  intl: IntlShape,
...
class ConsumerFilters extends React.Component<ConsumerFiltersProps> {

  constructor(props: ConsumerFiltersProps) {
    super(props);
...
// Apply styles
const styledComponent = withStyles(styles)(ConsumerFilters);
